...
class CreateTeamEPOC extends StatefulWidget {
  final TextStyle style;
  final int timeInMiliseconds;
  final Function onTimeComplete;
  CreateTeamEPOC({this.timeInMiliseconds, this.style, this.onTimeComplete});

  @override
  CreateTeamEPOCState createState() => CreateTeamEPOCState();
}

class CreateTeamEPOCState extends State<CreateTeamEPOC> {
  Timer _timer;
  int leftDays = 0;
  int leftHours = 0;
  int leftMinutes = 0;
