...
class PredictionDetailsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool bIsContestFull = (predictionSheets != null &&
            contest.teamsAllowed <= predictionSheets.length) ||
